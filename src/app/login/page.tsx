        ...
        <div className="rounded-2xl border border-es-bg-tertiary/50 bg-es-bg-secondary/80 backdrop-blur-sm p-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 rounded-xl bg-[#1DB954] px-6 py-3.5 font-inter font-medium text-white shadow-lg hover:bg-[#1ed760] hover:shadow-xl hover:scale-[1.02] transition-all w-full"
            >
